    ...
    <main className="min-h-screen overflow-hidden text-slate-950" style={{ backgroundColor: secondary }}>
      <section className="relative px-4 py-6 md:px-6 md:py-8">
        ...
        <div className="mx-auto max-w-7xl space-y-5">
          <header className="flex items-center gap-4 rounded-[1.75rem] bg-white/90 p-4 shadow-xl backdrop-blur md:p-5">
            <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl font-black text-white" style={{ backgroundColor: primary }}>
              {employee.employer_logo_url ? (
                <img src={employee.employer_logo_url} alt={employee.employer_name} className="h-full w-full object-cover" />
              ) : (
          ...
          <section className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="rounded-[2rem] bg-white p-6 shadow-2xl md:p-8">
              ...
              <p className="mt-4 max-w-2xl text-base leading-relaxed text-slate-600 md:text-lg">
                Your program is supported by <strong>{employee.team_name}</strong>. Start with resources, take the readiness quiz,
                then request time with a trusted expert when you are ready.
              </p>
            ...
            <div className="overflow-hidden rounded-[2rem] bg-white shadow-2xl">
              ...
              <div className="p-5">
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-600">
                  {employee.team_description || "Mortgage, real estate, and home-buying support connected to your employer benefit."}
                </p>
              </div>
            </div>
          </section>
              ...
              <div>
                ...
                <div className="mt-4">
                  ...
                  <div className="h-3 rounded-full bg-slate-100">
                    <div className="h-3 rounded-full transition-all" style={{ width: `${progressPercent}%`, backgroundColor: primary }} />
                  </div>
                </div>
              </div>
          ...
          <section className="overflow-hidden rounded-[2rem] bg-white shadow-2xl">
            <div className="grid gap-0 lg:grid-cols-[0.78fr_1.22fr]">
              <div className="relative overflow-hidden p-8 text-white" style={{ background: `linear-gradient(135deg, ${primary}, #111827)` }}>
                ...
                <p className="mt-4 text-base leading-relaxed text-white/80">Choose an advisor for a focused appointment or start a message in Communication Center.</p>
                <div className="mt-7 rounded-2xl bg-white/12 p-4 backdrop-blur">
              ...
              <div className="bg-slate-50 p-5 md:p-7">
                <div className="grid gap-4">
                  ...
                  {data.team_members.length === 0 && (
                    <div className="rounded-3xl bg-white p-8 text-center text-slate-500 shadow-sm">Your Home Buying Team will appear here once advisors are assigned.</div>
                  )}
                </div>
              </div>
            </div>
