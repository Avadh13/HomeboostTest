      ...
      <div className="mx-auto max-w-7xl space-y-8">
          ...
          <div className="relative flex flex-col justify-between gap-8 md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-lg text-slate-300">
                Welcome, <strong className="text-white">{user.full_name || "HBT Member"}</strong>. Manage your partnerships, employees, resources, events, and team members from one command center.
              </p>
            </div>
        ...
        <section className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="rounded-[2rem] bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white shadow-2xl shadow-blue-500/30">
            ...
            <p className="mt-4 text-blue-50">Open employer partnerships, verify branded employer pages, manage employee enrollment, then review quiz activity and engagement.</p>
            <Link to="/hbt/companies" className="mt-6 inline-flex rounded-full bg-white px-6 py-3 font-black text-blue-700 transition hover:-translate-y-1">
              Review partnerships
            </Link>
          </div>
          <div className="rounded-[2rem] bg-white p-8 shadow-xl">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {["Role-based login", "Partnership ownership", "Employee engagement"].map((item) => (
